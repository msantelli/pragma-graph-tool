/**
 * Human/LLM-facing metadata for the type system: glosses, canonical
 * endpoint types, qualifiers, BSD/Miller references, and the Brandom
 * composition rules the derive engine recognises.
 *
 * This is the single source of truth for schema discovery — the CLI's
 * `schema` verbs and any GUI help surfaces read from here. A consistency
 * test guarantees every NodeType/EdgeType literal in types.ts has an entry.
 */
...
export const EDGE_TYPES_DETAILS: Record<string, EdgeTypeMeta> = {
...
export const EDGE_TYPES_GROUPED = {
  MUD: {
    basic: ['PV', 'VP', 'PP', 'VV'],
...
export const BRANDOM_COMPOSITION_RULES = [
  {
...
// Field-level documentation surfaced by `schema all`.
...
export const COMMON_EDGE_FIELDS = {
  id: 'string (auto-generated UUID)',
